...
class RunningOrder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<RunningOrderCubit, RunningOrderState>(
      builder: (context, state) {
        if (state is RunningOrderLoading) {
          return const Center(child:  LoadingWidget());
        } else if (state is RunningOrderStateError) {
          return Center(child: Text(state.message));
        } else if (state is RunningOrderStateLoaded) {
          return Column(
            children: [
